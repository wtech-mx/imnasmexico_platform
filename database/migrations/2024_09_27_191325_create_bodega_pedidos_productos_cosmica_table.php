...
return new class extends Migration
{
    ...
    {
        Schema::create('bodega_pedidos_productos_cosmica', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('id_pedido');
            $table->foreign('id_pedido')
                ->references('id')->on('bodega_pedidos_cosmica')
                ->inDelete('set null');
    ...
    {
        Schema::dropIfExists('bodega_pedidos_productos_cosmica');
    }
};
