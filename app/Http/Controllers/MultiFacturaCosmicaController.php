...
class MultiFacturaCosmicaController extends Controller
{
    ...
    public function CFDI_facturaDeContado($id_orden)
    {
        ...
        $orden = NotasProductosCosmica::with(['User', 'ProductosNotasId.Productos'])->find($id_orden);
    ...
    {
        $orden = NotasProductosCosmica::findOrFail($id_orden);
