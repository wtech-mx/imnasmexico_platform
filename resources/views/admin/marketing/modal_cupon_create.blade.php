<!-- Modal -->
<div class="modal fade" id="create_cupon" tabindex="-1" role="dialog" aria-labelledby="create_cupon" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="create_cupon">Crear cupon</h5>
            ...
            <form method="POST" action="{{ route('cupones.store') }}" enctype="multipart/form-data" role="form">
                @csrf
                ...
                <div class="form-group col-6">
                    ...
                    <div class="input-group mb-2 mr-sm-2">
                      ...
                      <input type="number" class="form-control" id="limite_uso_por_cupon" name="limite_uso_por_cupon">
                    </div>
                </div>
