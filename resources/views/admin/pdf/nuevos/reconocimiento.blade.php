...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-4 text-center border"  style="margin-top: 60px">
                <img src="https://plataforma.imnasmexico.com/documentos_nuevos/reconocimiento/sello-reconocimiento.webp" style="width: 120px;" alt="{{ $basePath . 'sello-reconocimiento.webp'}}">
            </div>
