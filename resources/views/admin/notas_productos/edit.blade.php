    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('notas_productos.update', $cotizacion->id) }}" enctype="multipart/form-data" role="form" id="formulario-cotizacion">
                            @csrf
                            <input type="hidden" name="_method" value="PATCH">
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-12 mt-2">
                                        <h5>Tiendita #{{ $cotizacion->folio }}</h5>
