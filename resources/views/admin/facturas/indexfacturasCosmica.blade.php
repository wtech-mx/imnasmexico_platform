          ...
          <div class="card">
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <h3 class="mb-3">Facturas Cosmica</h3>
            ...
            <div class="table-responsive">
                <table class="table table-flush" id="datatable-search">
                    ...
                    <tr>
                        ...
                        <td>
                            @php
                                 $precio = number_format($factura->NotasCosmica->total, 2, '.', ',');
                            @endphp
                            $ {{ $precio }}
                        </td>
                        ...
                        <td>
                            ...
                            @can('factura-compra')
                                <a target="_blank" class="btn btn-sm btn-warning" href="{{ route('pagos.edit_pago',$factura->NotasCosmica->id) }}">
