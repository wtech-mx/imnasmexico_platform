          ...
          <div class="card">
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <h3 class="mb-3">Facturas Cursos por fuera</h3>
            ...
            <div class="table-responsive">
                <table class="table table-flush" id="datatable-search">
                    ...
                    <tr>
                        ...
                        <td>{{ $factura->NotasCursos->User->name }}</td>
                        <td>{{ $factura->NotasCursos->User->telefono  }}</td>
                        <td>#{{ $factura->NotasCursos->id }}</td>

                        <td>
                            {{ $factura->NotasCursos->folio }}
                        </td>
                        ...
                        <td>
                            @php
                                 $precio = number_format($factura->NotasCursos->total, 2, '.', ',');
                            @endphp
                            $ {{ $precio }}
                        </td>
                        ...
                        <td>
                            ...
                            @can('factura-compra')
                                <a target="_blank" class="btn btn-sm btn-warning" href="{{ route('pagos.edit_pago',$factura->NotasCursos->id) }}">
