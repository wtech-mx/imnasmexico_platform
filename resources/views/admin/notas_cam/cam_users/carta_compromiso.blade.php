                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-end">
                                <p>Ciudad de México a  ___ de ________________ del 202__</p>
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <p>
                                Por este conducto manifiesto que yo _________________________________________, <br>
                        ...
                        <div class="row">
                            ...
                            <form method="POST" class="row" action="" enctype="multipart/form-data" role="form">
                                ...
                                <div class="col-6">
                                    ...
                                    <h6 class="text-left mt-3 mb-3">Nombre completo:</h6>
