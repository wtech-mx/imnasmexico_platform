    ...
    <div class="modal-dialog modal-dialog-centered modal-xs" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form row" action="{{ route('distribuidoras.update_estatus', $nota->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    $('.modal').on('shown.bs.modal', function() {
        ...
        $modal.find('.metodo-pago').change(function() {
            ...
            if (selectedValue === 'Envio') {
                ...
                $modal.find('.metodo-pago-tienda-select').hide();
                ...
                $modal.find('#fecha_entrega, #direccion_entrega, #guia_rep, #comentario_rep').val('');
                    ...
                    $modal.find('#fecha_entrega').attr('required', false);
                    $modal.find('#foto_pago').attr('required', true);
