...
<div class="row card card-body card_colapsable_comprar">
    ...
    <div class="col-12">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-6 my-auto">
                <a href="{{ route('folio.index_cedula',$tickets_externo->folio) }}" class="btn btn-xs mt-3 w-100 text-dark" style="background-color: #DDD78D">Cedulda de Identidad de Papel</a>
