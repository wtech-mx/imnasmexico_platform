<!-- Modal -->
<div class="modal fade" id="renovar" tabindex="-1" role="dialog" aria-labelledby="renovar" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4>Renovar registro</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="background: {{$configuracion->color_boton_close}}; color: #ffff">
                    <span aria-hidden="true">X</span>
                </button>
            </div>

            <form method="POST" action="{{ route('renovar.update', $cliente->id) }}" enctype="multipart/form-data" role="form">
                @csrf
