                        ...
                        <div class="table-responsive">
                            ...
                            <nav>
                              ...
                              <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-Pendiente" role="tabpanel" aria-labelledby="nav-Pendiente-tab" tabindex="0">
                                ...
                                <div class="tab-pane fade" id="nav-Aprobada" role="tabpanel" aria-labelledby="nav-Aprobada-tab" tabindex="0">
                                    <table class="table table-flush" id="datatable-search2">
                                        ...
                                        <tbody>
                                            @foreach ($notasAprobadas as $nota)
                                                <tr>
                                                    <td>
                                                        <h5>
                                                            @if ($item->folio == null)
                                ...
                                <div class="tab-pane fade" id="nav-Cotizacion" role="tabpanel" aria-labelledby="nav-Cotizacion-tab" tabindex="0">
