    ...
    <div class="modal-dialog  modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 class="modal-title">Cambio de Estatus T{{$item->id}}</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>

            <form method="POST" action="{{ route('notas_cotizacion.update_t_cosmica', $item->id) }}" enctype="multipart/form-data" role="form">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-select d-inline-block"  data-toggle="select" id="estatus_bodega" name="estatus_bodega">
