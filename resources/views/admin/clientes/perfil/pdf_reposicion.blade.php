...
<html lang="en">
  <head>
    ...
    <title>Aprobar reposicion</title>
            ...
            <div class="row">
                <div class="col-12 mt-3">
                    ...
                    <div class="col-12 mt-5">
                        <h5 style="color:#836262"><strong>Folio Original: {{ $pedido_original->folio }}</strong> </h5><br>
                    </div>
                    <ul>
                        @foreach ($pedido_productos as  $productos)
                            <li>
                                {{$productos->ProductosRepo->nombre}} <br>
                                {{$productos->cantidad_reposicion}} - {{$productos->Productos->nombre}}
                            </li>
                        @endforeach
                    </ul>
                    <div class="row">
                        <div class="col-12">
                            <p class="text-left"> <strong>Comentario</strong></p>
                        ...
                        <form method="POST" class="row" action="" enctype="multipart/form-data" role="form">
                            ...
                            @if($pedido->firma_reposicion)
                                ...
                                <p class="text-center">
                                    <img id="blah" src="{{asset('firma_pedido/' .$pedido->firma_reposicion   ) }}" alt="Imagen" style="width: 100%;height: auto;"/><br>
                                </p>
