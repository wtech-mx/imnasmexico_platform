...
<!-- Modal -->
<div class="modal fade" id="reporte_{{ $item->id }}" tabindex="-1" aria-labelledby="chatModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="chatModalLabel">Reporte de Chat {{ $item->folio }}</h5>
            ...
            <div class="modal-body">
                ...
                @foreach ($reportes as $reporte)
                    @if ($item->id == $reporte->id_cotizacion_nas)
                ...
                <form method="POST" action="{{ route('peril_cliente.reporte_nas') }}" enctype="multipart/form-data" role="form" >
                    @csrf
                    <div class="input-group mt-3">
                        <input type="text" name="id_cotizacion" id="id_cotizacion" value="{{ $item->id }}" hidden>
