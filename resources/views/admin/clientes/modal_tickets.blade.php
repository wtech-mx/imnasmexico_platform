                    ...
                    <div class="row">
                            @if(!empty($orders))
                                @foreach($orders as $order)
                                        ...
                                        <div class="col-2">
                                            <button class="btn btn-sm btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#ticket_{{ $order->id }}" aria-expanded="false" aria-controls="ticket_{{ $order->id }}">
