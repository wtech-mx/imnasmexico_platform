                    ...
                    <div class="col-12">
                        <form method="POST" action="{{ route('generar_enviar.documento') }}" enctype="multipart/form-data" role="form">
                            ...
                            <div class="row">
                                    ...
                                    <div class="gc_cn" style="">
                                        ...
                                        <div class="row">
                                            ...
                                            @if ($order->User->Documentos)
                                                @if ($order->User->Documentos->firma !== null)
                                                    <div class="form-group col-6 gc_cn">
                                                        <label for="name">Firma Personal s*</label>
                                                        <div class="input-group">
                                                            <span class="input-group-text" id="basic-addon1">
                                                                <img class="img_profile_label" src="{{asset('assets/user/icons/firma-digital.png')}}" alt="" width="30px">
                                                            </span>
                                                ...
                                                @if ($order->User->Documentos->foto_infantil_blanco !== null)
                                    ...
                                    <div class="col-12">
                                        <button type="submit" class="btn close-modal" style="background: {{$configuracion->color_boton_save}}; color: #ffff"> <i class="fa fa-send" title="Ver Orden"></i>Generar Doc</button>
                                    </div>
