    ...
    <div class="row " style="background-color: #fff">
        ...
        <div class="col-12 mt-4 p-5">
            ...
            @if(Route::currentRouteName() != 'folio.index')
                ...
                @else
                    {{-- Alumnos imnas --}}
                    @if ($tickets_generador == "" && $tickets_externos == "")
                ...
                @else
                        {{-- Registro imnas --}}
                    @if ($tickets == NULL && $tickets_externos == "")
                    <h5 class="text-left mt-5 mb-3"><strong>Resultado de Busqueda del Folio : {{ $folio}}</strong></h5>
                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 col-lg-6">
                                    ...
                                    <p class="text-center mt-4">
                                        <strong>Nombre del Alumno:</strong> {{$tickets_externos->cliente}} <br>
                                        <strong>Especialidad:</strong> {{$tickets_externos->curso}} <br>
                                        <strong>Escuela donde estudió:</strong> INSTITUTO MEXICANO NATURALES AIN SPA <br>
                                        <strong>Fecha que estudió del:</strong> {{ \Carbon\Carbon::parse($tickets_externos->fecha_inicial)->isoFormat('DD [de] MMMM [del] YYYY') }}<br>
                                    </p>
                                    <p class="text-center mt-4">
                                        La coordinación de asuntos escolares del Registro Nacional IMNAS con registro en la
                                        Secretaría del Trabajo y Previsión Social (STPS) como agente capacitador externo
                                        RIFC680910-879-0013 hace constar que el alumno con número de FOLIO <strong>{{ $folio}}</strong>
                                        ha terminado satisfactoriamente la especialidad <strong>{{$tickets_externos->curso}}</strong> con los créditos honoríficos
                                        requeridos respecto al plan de estudios vigente.
                                    </p>
                                </div>

                                <div class="col-12 col-md-6 col-lg-6 my-auto">
                                    <a href="{{ route('folio.index_cedula',$tickets_externos->folio) }}" class="text-center btn btn-xs mt-3 w-100 text-dark" style="background-color: #DDD78D">Cedulda de Identidad de Papel</a>
                                    <a href="{{ route('folio.index_crednecial',$tickets_externos->folio) }}" class="text-center btn btn-xs mt-3 w-100 text-dark" style="background-color: #DCBF85">Credencial Plastificada</a>
                                    <a href="{{ route('folio.index_diploma',$tickets_externos->folio) }}" class="text-center btn btn-xs mt-3 w-100 text-white" style="background-color: #8B635C">Diploma Imnnas</a>
                                    <a href="{{ route('folio.index_titulo',$tickets_externos->folio) }}" class="text-center btn btn-xs mt-3 w-100 text-white" style="background-color: #60594D">Titulo Honorifico</a>
                                    {{-- <a href="{{ route('folio.index_tira',$tickets->id) }}" class="btn btn-xs mt-3 w-100 text-white" style="background-color: #93A29B">Tira de Materias</a> --}}
                                </div>
