...
<section class="primario bg_overley" style="position:relative;background-image: url('{{asset('assets/user/utilidades/pattern.jpg') }}')">
...
<section class="primario bg_overley" style="background-color:#F5ECE4;" id="cafeteria">
    <div class="row">
        ...
        <div class="col-12">
            <h4 class="text-white text-center titulo mt-5 mb-lg-5 mb-md-5" style="color:#836262!important;">
                CDMX
            </h4>
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-xl-3 mb-lg-3 mb-md-2 m-auto">
            <div class="card_reality" style="position: relative">
                <p class="text-center">
                    <img class="img_reality_alumnas descalificado" src="{{asset('assets/user/utilidades/producto_palciacion.jpg') }}" style="width: 80%;">
                </p>
                <p class="text-center">
        ...
        <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-xl-3 mb-lg-3 mb-md-2 m-auto">
            <div class="card_reality" style="position: relative">
                <p class="text-center">
                    <img class="img_reality_alumnas descalificado" src="{{asset('assets/user/utilidades/lab.jpg') }}" style="width: 80%;">
                </p>
                <p class="text-center">
        ...
        <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-xl-3 mb-lg-3 mb-md-2 m-auto">
            <div class="card_reality" style="position: relative">
                <p class="text-center">
                    <img class="img_reality_alumnas descalificado" src="{{asset('assets/user/utilidades/cosmetologa_bg.jpg') }}" style="width: 80%;">
                </p>
                <p class="text-center">
        ...
        <div class="col-12 col-md-6 col-lg-4 col-xl-3 mb-xl-3 mb-lg-3 mb-md-2 m-auto">
            <div class="card_reality" style="position: relative">
                <p class="text-center">
                    <img class="img_reality_alumnas descalificado" src="{{asset('assets/user/utilidades/IMAGEN-HOME.webp') }}" style="width: 80%;">
                </p>
                <p class="text-center">
