...
<section class="primario bg_overley margin_home_nav" style="background-color:#F5ECE4;" id="cafeteria">
    <div class="row">
        ...
        <div class="col-12 col-md-12  m-auto">
            <h1 class="text-white text-center titulo mt-5 " style="color:#836262!important;">Facturacion Tiendita</h1>
...
$(function(){
  $('#btnBuscarFolio').on('click', function(){
    ...
    $.ajax({
      url: '{{ route("facturacionTiendita.search") }}',
      data: { folio },
      success(response) {
