                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        <ul class="nav nav-tabs" id="myTabs">
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link" id="tab_doc" data-bs-toggle="tab" href="#content_doc{{$video->id_tickets}}" role="tab" aria-controls="content_doc" style="" class="tab_profile_materials" aria-selected="true">Documentos <img src="{{ asset('assets/user/icons/cedula.png') }}" alt="" class="img_tabs_profile_ss" style=""></a>
                                                            </li>
                                                            @if ($video->Cursos->CursosEstandares->count() > 0)
                                                                <li class="nav-item">
                                                                    <a class="nav-link" id="tab_estandar" data-bs-toggle="tab" href="#content_estandar{{$video->id_tickets}}" role="tab" aria-controls="content_estandar" style="" class="tab_profile_materials" aria-selected="true">Estandares <img src="{{ asset('assets/user/icons/certificacion.webp') }}" alt="" class="img_tabs_profile_ss" style=""></a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" id="tab_descargas" data-bs-toggle="tab" href="#content_descargas{{$video->id_tickets}}" role="tab" aria-controls="content_descargas" style="" class="tab_profile_materials" aria-selected="true">Descargas Documentos <img src="{{ asset('assets/user/icons/documentos.png') }}" alt="" class="img_tabs_profile_ss" style=""></a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" id="tab_register" data-bs-toggle="tab" href="#content_register{{$video->id_tickets}}" role="tab" aria-controls="content_register" style="" class="tab_profile_materials" aria-selected="true">Subir Documentos <img src="{{ asset('assets/user/icons/folder.png') }}" alt="" class="img_tabs_profile_ss" style=""></a>
                                                                </li>
                                                            @endif
                                                            <li class="nav-item">
                                                    ...
                                                    <div class="tab-content" id="myTabContent">
                                                        ...
                                                        <div class="tab-pane fade" id="content_doc{{$video->id_tickets}}" role="tabpanel" aria-labelledby="nav-login-tab" tabindex="0" style="min-height: auto!important;">
                                                                            ...
                                                                            <div class="row">
                                                                                @foreach ($documentos_estandar as $documento)
                                                                                    ...
                                                                                    <div class="col-12">
                                                                                        <p class="text-center mt-2">
                                                                                            <a href="{{asset('carpetasestandares/'.$estandar->nombre. '/' .$documento->nombre) }}" download="{{$documento->nombre}}" style="text-decoration: none; color: #000">
                                                                                                <img src="{{asset('assets/user/icons/docx.png') }}" style="width: 45px; height: 45px;"/>
                                                                                                {{ substr($documento->nombre, 13) }}
                                                                                            </a>
                                                                                            <a class="text-center text-white btn btn-sm" href="{{asset('carpetasestandares/'.$estandar->nombre. '/' .$documento->nombre) }}" download="{{$documento->nombre}}" style="background: #836262; border-radius: 19px;">
                                                                                                Descargar
                                                            ...
                                                            <div class="tab-pane fade" id="content_register{{$video->id_tickets}}" role="tabpanel" aria-labelledby="nav-register-tab" tabindex="0" style="min-height: auto!important;">
                                                                @php
