...
<head>
  ...
  <link href="{{ asset('plataforma/assets/admin/css/nucleo-svg.css')}}" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
  <link href="{{ asset('plataforma/assets/admin/css/nucleo-svg.css')}}" rel="stylesheet" />
  @yield('css')
   <!-- Select2  -->
   <link rel="stylesheet" href="{{ asset('plataforma/assets/admin/vendor/select2/dist/css/select2.min.css')}}">

  <!-- CSS Files -->
  <link id="pagestyle" href="{{ asset('plataforma/assets/admin/css/argon-dashboard.css?v=2.0.4')}}" rel="stylesheet" />
...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <!--   Core JS Files   -->
  {{-- <script src="{{ asset('plataforma/assets/admin/vendor/jquery/dist/jquery.min.js')}}"></script> --}}

  <script src="{{ asset('plataforma/assets/admin/js/core/popper.min.js')}}"></script>

  <script src="{{ asset('plataforma/assets/admin/js/core/bootstrap.min.js')}}"></script>
  <script src="{{ asset('plataforma/assets/admin/js/plugins/perfect-scrollbar.min.js')}}"></script>
  <script src="{{ asset('plataforma/assets/admin/js/plugins/smooth-scrollbar.min.js')}}"></script>

  <script src="{{ asset('plataforma/assets/admin/js/plugins/datatables.js')}}"></script>

  <script src="{{ asset('plataforma/assets/admin/js/plugins/fullcalendar.min.js')}}"></script>
  <!-- Kanban scripts -->

  <script src="{{ asset('plataforma/assets/admin/js/plugins/dragula/dragula.min.js')}}"></script>
  <script src="{{ asset('plataforma/assets/admin/js/plugins/jkanban/jkanban.js')}}"></script>
  <script src="{{ asset('plataforma/assets/admin/js/plugins/chartjs.min.js')}}"></script>
  <script src="{{ asset('plataforma/assets/admin/js/argon-dashboard.min.js')}}"></script>
  <script src="{{ asset('plataforma/assets/admin/js/plugins/multistep-form.js')}}"></script>
