...
<div class="container ">
    ...
    <div class="row">
            ...
            <div class="container_lineas_single_product">
                <div class="content mb-3 mt-3">
                    <div class="img_container_single_product mx-auto">
                        <img class="img_grid_products_single_product" src="{{asset('products/'.$cotizacion->imagenes) }}" alt="Protector">
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 col-sm-12 col-md-7 col-lg-8 p-1 p-sm-1 p-md-3 p-lg-5">
            ...
            <h1 class="text-center name_product"><strong>{{$cotizacion->nombre}}</strong></h1>

            <div class="container_price  mt-3 mt-sm-3 mt-md-4 mt-lg-5 mb-3 mb-sm-3 mb-md-3 mb-lg-5">
                <div class="d-flex justify-content-around">
                    <h2 class="my-auto price">${{number_format($cotizacion->precio_normal, 0, '.', ',')}}</h2>
                    <p class="my-auto">
                        <p class="my-auto">
                            <input type="number" id="cantidad_{{ $cotizacion->id }}" class="form-control d-inline-block" value="1" min="1" style="width: 60px;">
                        </p>
                        <a href="javascript:void(0);" class="btn-agregar" data-id="{{ $cotizacion->id }}">
                            <img class="icon_plus_cantidad" src="{{ asset('cosmika/inicio/AGREGAR-POPULARES.png') }}" alt="Carrito">
                        </a>
                    </p>
                    <a href="javascript:void(0)" class="btn btn_shop my-auto agregar-carrito" data-id="{{ $cotizacion->id }}">
                        Agregar
            ...
            <div class="contaner_details">
                ...
                <div class="row">
                    <div class="col-6">
                        <h3 class="detalles "> <strong>Nombre</strong> </h3>
                    </div>
                    <div class="col-2">
                        <h3 class="detalles text-center"> <strong>Cantidad</strong> </h3>
                    </div>
                    <div class="col-4">
                        <h3 class="detalles text-center"> <strong>Subtotal</strong> </h3>
                    </div>
                </div>

                @foreach ($cotizacion_productos as  $productos)
                    <div class="row" data-id="{{ $productos->id }}">
                        @php
                        ...
                        <div class="col-6">
                            <p class="detalles_dinamico">{{ $productos->producto }}</p>
                        </div>

                        <div class="col-2">
                            <p class="detalles_dinamico text-center">{{ $productos->cantidad }}</p>
                        </div>

                        <div class="col-4">
                            <p class="detalles_dinamico text-center">
                                ${{ $precio_format }}
                            </p>
                        </div>
        ...
        <div class="col-12 col-sm-12 col-md-8 col-lg-4 text-center">
            <div class="container_lineas_single  mt-4 mt-sm-2 mt-md-3 mt-lg-3 mb-4 mb-sm-2 mb-md-3 mb-lg-3">
                <a href="javascript:void(0)" class="text_shop_single agregar-carrito " data-id="{{ $cotizacion->id }}">
                    ${{number_format($cotizacion->precio_normal, 0, '.', ',')}} MXN Agregar
                </a>
            </div>
        </div>
