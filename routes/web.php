...
Route::get('cosmica/cotizacion/imprimir/expo/{id}', [App\Http\Controllers\CotizacionCosmicaController::class, 'imprimir_expo'])->name('cotizacion_cosmica.imprimir_expo');
Route::post('cotizacion-cosmica', [App\Http\Controllers\CotizadorController::class, 'store'])->name('cotizacion.store');
Route::post('/cotizacion/cosmica/store', [App\Http\Controllers\CotizadorController::class, 'store_cosmica_cotizacion'])->name('store_cosmica_cotizacion');
...
Route::get('/reportes/ventas-expo', [App\Http\Controllers\CotizadorController::class, 'ventasExpo'])->name('reportes.ventasExpo');
...
Route::get('/eliminar-documento/per/{id}/{tipo}', [App\Http\Controllers\ClientsController::class, 'eliminarDocumentoPer'])->name('eliminar.documentoper');
...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::get('/admin/cursos/mes/dev', [App\Http\Controllers\CursosController::class, 'index_mes_dev'])->name('cursos.index_mes_dev');
    ...
    Route::patch('/admin/cursos/update/estatus/{id}', [App\Http\Controllers\CursosController::class, 'update_estatus'])->name('cursos.update_estatus');
    ...
    Route::delete('/cotizacion_cosmica/kit/{kitId}/nota/{notaId}', [App\Http\Controllers\CotizacionCosmicaController::class, 'eliminarKit'])->name('cotizacion_cosmica.kit.eliminar');
